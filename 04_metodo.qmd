...
No nível estadual, foram compostos dois indicadores sobre infrações relacionadas à velocidade ($II_1$ e $II_2$), considerando apenas aquelas infrações detectadas por dispositivos eletrônicos de medição de velocidade (câmeras de segurança), ou seja, as infrações dos códigos **7455**, **7463** e **7471**, seja o medidor fixo, estático, móvel ou portátil. O ano de referência adotado foi de 2024. Foram utilizados os dados de infrações disponibilizados pela Secretaria Nacional de Trânsito [@brasil2025b_infracoes]. Os indicadores sobre infrações relacionadas à velocidade encontram-se listados a seguir:
